    ...
    <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-between gap-8">
      ...
      <div>
        ...
        <p className="opacity-70 mb-6 text-justify">
          Gamer Crit is a platform dedicated to providing unbiased and in-depth
          reviews for gamers, helping them make informed decisions before
          purchasing their next game. We focus on offering comprehensive
          evaluations, including gameplay mechanics, graphics, storylines, and
          overall user experience. Our goal is to highlight both the strengths
